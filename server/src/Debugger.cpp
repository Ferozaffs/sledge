                                              ...
                                              GLsizei /*length*/, const GLchar *message, const void * /*userParam*/)
{
    ...
    static std::map<GLenum, const GLchar *> sources = {{GL_DEBUG_SOURCE_API, "API"},
    ...
    static std::map<GLenum, const GLchar *> severities = {{GL_DEBUG_SEVERITY_HIGH, "HIGH"},
                                                          {GL_DEBUG_SEVERITY_MEDIUM, "MEDIUM"},
                                                          {GL_DEBUG_SEVERITY_LOW, "LOW"},
                                                          {GL_DEBUG_SEVERITY_NOTIFICATION, "NOTIFICATION"}};

    static std::map<GLenum, const GLchar *> types = {{GL_DEBUG_TYPE_ERROR, "ERROR"},
    ...
    printf("[OpenGL %s] - SEVERITY: %s, SOURCE: %s, ID: %d: %s\n", types[type], severities[severity], sources[source],
           id, message);
}
